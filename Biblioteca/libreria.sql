...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2020 a las 05:27:59
...
('Cualquiercosa', '2020-11-05', 'asdwqeq', 'wqewqe', 2, 'wqewqe', 'No', 'wqewqewqe', 'asd', 'asdqwe', 'libros/Captura de pantalla (15).png', 'autores/Captura de pantalla (21).png', 27);
...
INSERT INTO `likes` (`likeid`, `idcom`, `iduser`, `likes`, `dislikes`, `idlibro`) VALUES
(15, 13, 21, 0, 0, 16),
(16, 23, 21, 0, 1, 16),
(17, 24, 21, 1, 0, 16);
...
('Thiago', 'Valdiviezo', '2002-08-14', 'Pasta', 'Pasta@gmail.com', 'Pasta123', 21, 'usuarios/Captura de pantalla 2020-11-08 225917.png', b'1'),
...
--
ALTER TABLE `likes`
  ADD CONSTRAINT `likes_ibfk_1` FOREIGN KEY (`idcom`) REFERENCES `comentarios` (`idcom`),
  ADD CONSTRAINT `likes_ibfk_2` FOREIGN KEY (`iduser`) REFERENCES `usuarios` (`id_user`);
COMMIT;
